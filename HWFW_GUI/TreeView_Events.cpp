...
static void ListFileHeader(HWND hListView)
{
  ...
  ListView_AddColumn(hListView, 96, 0, L"File offset");
  ListView_AddColumn(hListView, 256, 1, L"Member value");
  ListView_AddColumn(hListView, 384, 2, L"Member description");
  ...
  ListView_AddItemW(hListView, ItemIndex(nIndex), 1, wsTemp, LT_NONE, 0, 0, 0);
  ListView_AddItemW(hListView, ItemIndexPlus(nIndex), 2, L"ProductListSize  #  Product support list size  (Little-Endian)", LT_NONE, 0, 0, 0);
...
void ListItemInfo(HWND hListView)
{
  ...
  ListView_AddColumn(hListView, 100, 0, L"Project information offset");
  ListView_AddColumn(hListView, 60, 1, L"Item Id");
  ListView_AddColumn(hListView, 288, 2, L"Project path");
  ListView_AddColumn(hListView, 96, 3, L"Project strategy");
  ListView_AddColumn(hListView, 96, 4, L"Item CRC32");
...
#else
  ListView_AddColumn(hListView, 104, 5, L"project type");
